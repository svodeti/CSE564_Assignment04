...
class TSPSolver extends Observable implements Runnable {
	private static TSPSolver _instance;
	
	private TSPSolver() {
	}
	
	/**
	 * This function is used to create the object class TSPSolver and if it is already created, it returns the old object.
	 * That is, there will only be one object this class with different references.
	 * 
	 * @return _instance object of class TSPSolver. 
	 */
