...
public class City {
	 ...
	 */
	 ...
	 /**
	  ...
	  public String getCityName() { return shape.getCityName(); }
	 ...
	 /**
	  ...
	  public void draw(Graphics g) { shape.draw(g); }
	  
	 /**
	 * When the city is dragged in the GUI, this function changes the co-ordinates
	 * of the city being dragged.
	 * 
	 * @param x x co-ordinate of the city
	 * @param y y co-ordinate of the city
	 */
	
	 public void move(int x, int y) { //bounds.x = x; bounds.y = y; 
	 }
	  
	 public Point center() { return shape.center(); }
	  
	 /**
	 * This function is used to connect two cities i.e draw a line between them in
	 * GUI.
	 * 
	 ...
	 */
	  ...
	  public void drawConnect(City b, Graphics2D g) { shape.drawConnect(b, g); }
	 ...
	 */
	  public boolean contains(int x, int y) { return shape.contains(x, y); }
